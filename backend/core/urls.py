...
urlpatterns = [
    ...
    path('announcements/<int:pk>/', AnnouncementDetail.as_view(), name='announcement-detail'),
        ...
        path('announcements/<int:announcement_id>/reactions/', views.toggle_reaction, name='announcement-reactions'),
            path('announcements/<int:announcement_id>/contact_owner/', views.contact_owner, name='announcement-contact-owner'),
...
path("chat/start_direct/", chat_views.start_direct_conversation, name="chat-start-direct"),
